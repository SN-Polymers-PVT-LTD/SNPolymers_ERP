...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 p-1.5 rounded-2xl bg-white/5 border border-white/10 w-fit mb-8">
        <button
          type="button"
        ...
        {isAllTab && (
          <button
            type="button"
            onClick={() => setTab('all')}
            className="flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold bg-amber-500 text-slate-950 shadow-md font-extrabold"
          >
            <span>📋</span>
              ...
              <div className="flex-grow text-center md:text-left">
                ...
                <div className="mt-4 flex flex-wrap gap-2 justify-center md:justify-start items-center">
                  ...
                  {profile.telegram_chat_id ? (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl text-[10px] font-semibold uppercase tracking-wider bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">
                      ...
                      <span>Telegram ID: {profile.telegram_chat_id}</span>
                    </span>
                  ) : (
                    <Link
                      to="/telegram-setup"
                      className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl text-[10px] font-semibold uppercase tracking-wider bg-amber-500/10 text-amber-400 border border-amber-500/20 hover:bg-amber-500/20 transition animate-pulse"
                      title="Set up Telegram bot notifications"
                    >
                      <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15.75-.8 3.51-1.12 4.79-.14.54-.34.72-.43.73-.2.02-.35-.13-.55-.26-.3-.21-.47-.32-.76-.51-.34-.23-.12-.35.07-.55.05-.05.94-.87.96-.95.002-.01.002-.04-.01-.05-.01-.01-.04-.01-.06.00-.03.01-.48.31-1.37.91-.13.09-.25.13-.36.13-.12-.01-.35-.07-.52-.13-.21-.07-.38-.11-.36-.23.01-.06.1-.12.26-.19 1.01-.44 1.68-.73 2.01-.87 1.92-.81 2.32-.95 2.58-.95.06 0 .19.01.27.08.07.06.09.14.1.22-.01.04-.01.12-.02.19z"/>
                      </svg>
                      <span>Telegram Setup Needed →</span>
                    </Link>
                  )}
                </div>
                ...
                {isProfileTab && (
                  <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between">
                    <span className="text-xs text-slate-400">Want to customize themes and backgrounds?</span>
                    <button
                      type="button"
                      onClick={() => setTab('appearance')}
