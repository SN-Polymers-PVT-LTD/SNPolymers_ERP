...
-- For partial payment, settle the original reservation before inserting the
-- compensating release. The release trigger only transitions RESERVED rows,
-- so this preserves the audit fact that the reservation was partly settled.
