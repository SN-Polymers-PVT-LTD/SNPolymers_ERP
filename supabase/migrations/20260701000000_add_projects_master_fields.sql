-- Migration: Add EMD and Site Info to projects_master and Update Audit Triggers
-- DB: PostgreSQL (Supabase)

-- 1. Add new columns to projects_master
ALTER TABLE projects_master 
ADD COLUMN IF NOT EXISTS earnest_money_deposit NUMERIC(18,2) NOT NULL DEFAULT 0.00,
...
-- 2. Update the audit trigger function to include earnest_money_deposit
